...
class AddFragment : Fragment()
    ...
    override fun onCreateView(
        ...
        addtowishlist_button.setOnClickListener {
            create(view.name_editText.text.toString(), view.barcode_textview.text.toString())
            Toast.makeText(applicationContext, "Added to Wishlist!", Toast.LENGTH_SHORT).show()
            view.name_editText.setText("")
            view.url_editText.setText("")
            view.barcode_textview.setText("")
...
override fun onResume() {
    ...
    view.next_button.setOnClickListener {
        val intent = Intent(fragmen, activity_add2::class.java)
